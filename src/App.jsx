...
import DriverDocuments from './pages/auth/DriverDocuments'
    ...
    <Routes>
      <Route element={<MainLayout />}>
        ...
        <Route
          path="/foto"
          element={
            <ProtectedRoute skipPhotoCheck skipDocumentsCheck>
              <ProfilePhoto />
            </ProtectedRoute>
          }
        />
        <Route
          path="/documentos"
          element={
            <ProtectedRoute skipDocumentsCheck>
              <DriverDocuments />
            </ProtectedRoute>
          }
        />
      ...
      {/* Perfil público de outro usuário — qualquer pessoa logada pode ver */}
      <Route
        element={
          <ProtectedRoute>
            <DashboardLayout />
