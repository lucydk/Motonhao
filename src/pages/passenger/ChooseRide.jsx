      ...
      {loading ? (
        ...
        <>
          ...
          <div className="ride-options">
            ...
            {/* Cartão extra, só de texto: não é uma opção de corrida (não tem
                preço nem tipo no banco), então não é clicável. */}
            <Card className="ride-option ride-option-static">
              <div className="ride-option-icon" aria-hidden="true">🛶</div>
              <div className="ride-option-info">
                <strong>Barconhão para o Saulo</strong>
              </div>
            </Card>
          </div>
        </>
